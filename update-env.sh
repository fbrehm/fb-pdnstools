...
usage() {
    ...
    cat <<-EOF
	Usage: ${BASENAME} [-d|--debug] [[-v|--verbose] | [-q|--quiet]] [-C|--nocolor]
	       ${BASENAME} [-h|--help]
	       ${BASENAME} [-V|--version]
	    ...
	    Options:
	        ...
	        -C|--nocolor    Don't use colors on display.
...
get_options() {
    ...
    local tmp=
    local short_options="dvqChV"
    local long_options="debug,verbose,quiet,nocolorhelp,version"
